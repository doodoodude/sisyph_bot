...
class SisyphStatePublisher:
    ...
    def __init__(self, nh):
        ...
        fid_listener = rospy.Subscriber("/aruco0/fiducial_transforms", FiducialTransformArray, self.fiducial_transforms_cb)
        ...
        self.tf_world_usbcam_msg.child_frame_id = "cam0" 
